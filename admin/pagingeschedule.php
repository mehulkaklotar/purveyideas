<?php
		...
		$query="select count(email_id) from eschedule where email_msg like '%".$search."%' or email_schedule like '%".$search."%' or email_group like '%".$search."%'";
...
?>    
       ...
       <?php 
		...
		if(isset($_REQUEST['search']))
			...
			{
				$sql1 ="select a.email_id,a.email_msg,a.email_schedule,a.email_group from (select email_id,email_msg,email_schedule,email_group from eschedule where email_msg like '%".$search."%' or email_group like '%".$search."%' or email_schedule like '%".$search."%' limit $offset,$rec_limit) a order by ".$_REQUEST['field']." ".$_REQUEST['order'];
			}
			else
			{
				$sql1 ="select * from eschedule where email_msg like '%".$search."%' or email_group like '%".$search."%' or email_schedule like '%".$search."%' limit $offset,$rec_limit";
        ...
        <?php include("eschedule_content.php"); ?>
