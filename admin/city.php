...
function recperpage()
{
   ...
   var url = "pagingcity.php?reclimit="+reclimit+"&search="+ssearch;
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingcity.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function insert_oe(e)
 ...
 function city_edit_oe(id,de,p,f,lp,lpr,r,e,o,f1)
 {
 	if (window.event) { e = window.event; }
        if (e.keyCode == 13)
        {    	 		
			city_edit(id,de,p,f,lp,lpr,r,o,f1);
 		}
		else
		{
			return;
...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","pagingcity.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "pagingcity.php?op=add&search="+ssearch+"&reclimit="+r;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();
  }
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    {    
     var ssearch = document.getElementById("txtsearch").value;
	 var url = "city_operation.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&rn="+Math.random() ;
    }
	else
	{
	  return checknone();
  ...
  function insert()
 {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	var r = document.getElementById("sel_limit").value;
		...
		if(name=="")
		{
			 ...
			 document.getElementById("d_city_name").innerHTML="*";
			 return;
		...
		{ 	
			document.getElementById("city_name").focus();			
			document.getElementById("d_city_name").innerHTML="Enter a valid city";
			 return;
		} 	 		
		else
			{
			 var url = "city_operation.php?op="+'insert' +"&name="+name +"&state="+state+"&search="+ssearch+"&reclimit="+r ;
  ...
  function city_edit(id,de,p,f,lp,lpr,r,o,f1)
 {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		{ 	
			...
			if(o!="0" && f1!="0")
			{
			var url = "city_operation.php?id="+id +"&op="+'edit' +"&name="+name +"&state="+state+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&order="+o+"&field="+f1+"&rn="+Math.random();
			}
			else
			{
			var url = "city_operation.php?id="+id +"&op="+'edit' +"&name="+name +"&state="+state+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();
			}
 ...
 function tsearch() 
  {
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
		 var r=document.getElementById("sel_limit").value;
	  	    var url="city_operation.php?search="+ssearch +"&op=search&reclimit="+r ;
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 document.getElementById("txtsearch").value="";
	  	    var url="city_operation.php?op=allsearch&reclimit="+r ;
    ...
    xmlhttp.onreadystatechange=function() 
	 {
	  ...
	  if(f=="1")
	 {
	 	var field="a.city_name";
	 }
	 else
	 {
	 	var field="a.state_name";
	 }
	 var ssearch = document.getElementById("txtsearch").value;
	
	  	    var url="pagingcity.php?search="+ssearch +"&op=search&order=asc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random() ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingcity.php?search="+ssearch +"&op=search&order=desc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
