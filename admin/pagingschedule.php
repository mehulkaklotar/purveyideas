<?php
		...
		$query="select count(sms_id) from schedule where sms_msg like '%".$search."%' or sms_mask like '%".$search."%' or sms_schedule like '%".$search."%' or sms_group like '%".$search."%'";
...
?>    
		...
		if(isset($_REQUEST['search']))
			...
			{
				$sql1 ="select a.sms_id,a.sms_msg,a.sms_mask,a.sms_schedule,a.sms_group from (select sms_id,sms_msg,sms_mask,sms_schedule,sms_group from schedule where sms_msg like '%".$search."%' or sms_mask like '%".$search."%' or sms_group like '%".$search."%' or sms_schedule like '%".$search."%' limit $offset,$rec_limit) a order by ".$_REQUEST['field']." ".$_REQUEST['order'];
			}
			else
			{
				$sql1 ="select * from schedule where sms_msg like '%".$search."%' or sms_mask like '%".$search."%' or sms_group like '%".$search."%' or sms_schedule like '%".$search."%' limit $offset,$rec_limit";
