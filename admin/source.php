...
function recperpage()
{
   ...
   var url = "pagingsource.php?reclimit="+reclimit+"&search="+ssearch;
...
function insert_oe(e)
 ...
 function source_edit_oe(id,de,p,f,lp,lpr,r,e,o)
 {
 	if (window.event) { e = window.event; }
        if (e.keyCode == 13)
        {    	 		
			source_edit(id,de,p,f,lp,lpr,r,o);
 		}
		else
		{
			return;
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingsource.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","pagingsource.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "pagingsource.php?op=add&search="+ssearch+"&reclimit="+r;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();
  }
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    {   
	var ssearch = document.getElementById("txtsearch").value; 
     var url = "source_operation.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&rn="+Math.random()  ;
    }
	else
	{
	  return checknone();
  ...
  function insert()
 {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		if(name=="")
		{
			 ...
			 document.getElementById("d_source_name").innerHTML="*";
			 return;
			...
			{
			 var url = "source_operation.php?op="+'insert' +"&name="+name+"&search="+ssearch+"&reclimit="+r;
  ...
  function source_edit(id,de,p,f,lp,lpr,r,o)
 {
   var xmlhttp;
   if(window.XMLHttpRequest)
   {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		if(name=="")
		{
			...
			if(o!="0")
			{
			var url = "source_operation.php?id="+id +"&op="+'edit' +"&name="+name+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&order="+o+"&rn="+Math.random() ;
			}
			else
			{
			var url = "source_operation.php?id="+id +"&op="+'edit' +"&name="+name+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&rn="+Math.random() ;
			}
 ...
 function tsearch() 
  {
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
		 var r=document.getElementById("sel_limit").value;
	  	    var url="source_operation.php?search="+ssearch +"&op=search&reclimit="+r ;
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 document.getElementById("txtsearch").value="";
	  	    ...
	  	    var url="source_operation.php?op=allsearch&reclimit="+r ;
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingsource.php?search="+ssearch +"&op=search&order=asc&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random() ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingsource.php?search="+ssearch +"&op=search&order=desc&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
