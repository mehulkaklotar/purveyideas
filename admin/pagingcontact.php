...
?>    
		...
		if(isset($_GET['search']))
			...
			$sql1 ="select a.contact_id,a.f_name,a.l_name,a.mobile1,a.email1,a.subscribe from (select contact_id,f_name,l_name,org_name,mobile1,email1,subscribe from contact_mst where f_name like '%".$search."%' or l_name like '%".$search."%' or org_name like '%".$search."%' or mobile1 like '%".$search."%' or email1 like '%".$search."%' limit $offset,$rec_limit) a order by ".$_GET['field']." ".$_GET['order'] ;						
			}
			else
			{
				$sql1="select contact_id,f_name,l_name,org_name,mobile1,email1,subscribe from contact_mst where f_name like '%".$search."%' or l_name like '%".$search."%' or org_name like '%".$search."%' or mobile1 like '%".$search."%' or email1 like '%".$search."%' limit $offset,$rec_limit";
			}
		$result1=mysql_unbuffered_query($sql1);
		$total_id="0";
		while($row1=mysql_fetch_array($result1))
		{
			$total_id.=",".$row1['contact_id'];
		}
