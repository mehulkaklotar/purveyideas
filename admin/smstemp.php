...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","pagingsmstemp.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "addsmstemp.php?reclimit="+r;
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    {    
	var ssearch = document.getElementById("txtsearch").value;
     var url = "smstemp_operation.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&reclimit="+r+"&lpr="+lpr+"&search="+ssearch+"&rn="+Math.random() ;
    }
	else
	{
	  return checknone();
  ...
  function insert(r)
 {
  ...
  function smstemp_edit(id,de,p,f,lp,lpr,r)
 {
   var xmlhttp;
   if(window.XMLHttpRequest)
   {
 ...
 function tsearch() 
  {
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
		 var r=document.getElementById("sel_limit").value;
	  	    var url="smstemp_operation.php?search="+ssearch +"&op=search&reclimit="+r ;
  ...
  function showall()
  {
   xmlhttp=GetXmlHttpObject();
	...
	document.getElementById("txtsearch").value="";
	  	    var url="smstemp_operation.php?op=allsearch&reclimit="+r ;
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 else if(f=="2")
	 {
	 	var field="sms_text";
	  	    ...
	  	    var url="pagingsmstemp.php?search="+ssearch +"&op=search&order=asc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random() ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
  ...
  function recperpage()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingsmstemp.php?reclimit="+reclimit+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingsmstemp.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingsmstemp.php?search="+ssearch+"&op=search&order=desc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
