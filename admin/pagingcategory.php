<?php
		...
		$query="select count(category_id) from category_mst where category_name like '%".$search."%'";
...
?>  		
       ...
       <?php 
		...
		if(isset($_GET['search']))
			...
			if(isset($_GET['order']))
			{
				$sql1 ="select a.category_id,a.category_name,a.parent_id from (select category_id,category_name,parent_id from category_mst where category_name like '%".$search."%' limit $offset,$rec_limit) a order by category_name ".$_GET['order'] ;				
			}
			else
			{
				$sql1 ="select * from category_mst where category_name like '%".$search."%'  limit $offset,$rec_limit";
        ...
        <?php include("category_content.php"); ?>	
         <?php
        }
		else
		{?>
