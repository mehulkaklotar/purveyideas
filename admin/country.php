...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","pagingcountry.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "pagingcountry.php?op=add&search="+ssearch+"&reclimit="+r;
...
function recperpage()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingcountry.php?reclimit="+reclimit+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingcountry.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    if (con == true)
    {    
     var url = "country_insert.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&rn="+Math.random();
    }
	else
	{
	  return checknone();
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		if(name=="")
		{
			...
			document.getElementById("d_country_name").innerHTML="*";
			 return;
		...
		{ 	
			document.getElementById("country_name").focus();			
			document.getElementById("d_country_name").innerHTML="Enter a valid country";
			 return;
		}
		 		
		else
			{
			 var url = "country_insert.php?op=insert&name="+name+"&search="+ssearch+"&reclimit="+r;
 ...
 function country_edit(id,de,p,f,lp,lpr,r,o)
 {
   var xmlhttp;
   if(window.XMLHttpRequest)
   {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		{ 	
			...
			if(o!="0")
			{
				var url = "country_insert.php?id="+id+"&op=edit&name="+name+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&order="+o+"&rn="+Math.random();
			
			}
			else
			{
			 var url = "country_insert.php?id="+id+"&op=edit&name="+name+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();
			 }
			}
	 xmlhttp.open("GET",url,true);
     xmlhttp.send();	
 ...
 function country_edit_oe(id,de,p,f,lp,lpr,r,e,o)
 {
 	if (window.event) { e = window.event; }
        if (e.keyCode == 13)
        {    	 		
			country_edit(id,de,p,f,lp,lpr,r,o);
 		}
		else
		{
			return;
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var r=document.getElementById("sel_limit").value;
	  	    ...
	  	    var url="country_insert.php?search="+ssearch +"&op=search&reclimit="+r ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var r = document.getElementById("sel_limit").value;
		document.getElementById("txtsearch").value="";
	  	    var url="country_insert.php?op=allsearch&reclimit="+r ;
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingcountry.php?search="+ssearch +"&op=search&order=asc&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingcountry.php?search="+ssearch +"&op=search&order=desc&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
