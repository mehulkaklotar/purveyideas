...
<div id="maincontent">
   ...
   <?php } ?>
    ...
    <div id="content">
	<?php include_once("paginggroup.php");?>
    </div>
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	{
	 document.getElementById("group_view").innerHTML = xmlhttp.responseText;
	}
   }
   ...
   for(var i=1;i<=md.length-2;i++)
   {
	...
	var url="sendsms.php?id="+id+"&message="+message+"&mask="+mask+"&grp=yes";
	//alert(url);
...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","paginggroup.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function insert_oe(e)
 ...
 function group_edit_oe(id,de,p,f,lp,lpr,r,e,o)
 {
 	if (window.event) { e = window.event; }
        if (e.keyCode == 13)
        {    	 		
			group_edit(id,de,p,f,lp,lpr,r,o);
 		}
		else
		{
			return;
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "paginggroup.php?op=add&search="+ssearch+"&reclimit="+r;
...
function recperpage()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "paginggroup.php?reclimit="+reclimit+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "paginggroup.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    if (con == true)
    {    
     var url = "group_operation.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&search="+ssearch+"&rn="+Math.random();
    }
	else
	{
	  return checknone();
  ...
  function insert()
 {
  ...
  xmlhttp.onreadystatechange = function()
   {
	...
	// alert(name);
		...
		if(name=="")
		{
			...
			document.getElementById("d_group_name").innerHTML="*";
			 return;
			...
			{
			 var url ="group_operation.php?op=insert&name="+name+"&search="+ssearch+"&reclimit="+r;
  ...
  function group_edit(id,de,p,f,lp,lpr,r,o)
 {
  ...
  xmlhttp.onreadystatechange = function()
   {
    if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
	{
     ...
     var name = document.getElementById("txtgroup").value;
	var s=document.getElementById("txtsearch").value;
	// alert(name);
		...
		if(name=="")
		{
			...
			if(o!="0")
			{
			var url = "group_operation.php?id="+id+"&op=edit&name="+name+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&order="+o+"&rn="+Math.random();
			}
			else
			{
			var url = "group_operation.php?id="+id+"&op=edit&name="+name+"&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();
			}
  ...
  xmlhttp.onreadystatechange = function()
   {
    if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
	{
	 document.getElementById("content").innerHTML = xmlhttp.responseText;
			 ...
			 var url = "paginggroup.php";
			 var s=document.getElementById("txtsearch").value;
			 
			 if(o!="0")
			 {
			  url = url +"?id="+cid+"&op=update&search="+s+"&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&order="+o+"&rn="+Math.random();
			 }
			 else
			 {
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var r=document.getElementById("sel_limit").value;
	  	    ...
	  	    var url="group_operation.php?search="+ssearch +"&op=search&reclimit="+r ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var r = document.getElementById("sel_limit").value;
		document.getElementById("txtsearch").value="";
	  	    var url="group_operation.php?op=allsearch&reclimit="+r ;
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="paginggroup.php?search="+ssearch +"&op=search&order=asc&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="paginggroup.php?search="+ssearch +"&op=search&order=desc&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
