...
<div id="maincontent">
   ...
   <?php } ?>
    ...
    <div id="content">
	<?php include_once("pagingschedule.php");?>
    </div>
...
function template_change()
{
	if (window.XMLHttpRequest)
		...
		xmlhttp.open("GET","addschedule.php?tid="+id+"&msg="+msg+"&mask="+mask+"&schedule="+schedule+"&hour="+hour+"&minute="+minute+"&second="+second+"&ids="+ids+"&editid="+editid,true);
		xmlhttp.send(null);	
}
...
{		
	//	alert("sd");
		...
		xmlhttp.open("GET","pagingschedule.php?page="+d+"&page_no_start="+p+"&flag="+f+"&search="+s+"&reclimit="+r+"&rn="+Math.random(),true);
		xmlhttp.send(null);		
}
...
function addrecord()
  ...
  xmlhttp.onreadystatechange = function()
   ...
   var url = "addschedule.php?reclimit="+r;
...
function mdelete(de,p,f,lp,lpr,r)
 {
  ...
  xmlhttp.onreadystatechange = function()
  {
   ...
   else
   {
    ...
    {    
	var ssearch = document.getElementById("txtsearch").value;
     var url = "schedule_operation.php?id_delete="+id_delete +"&op=delete&page="+de+"&flag="+f+"&page_no_start="+p+"&lastpage="+lp+"&reclimit="+r+"&lpr="+lpr+"&search="+ssearch+"&rn="+Math.random() ;
    }
	else
	{
	  return checknone();
   ...
   for(var i=1;i<=md.length-1;i++)
   {
	...
	if(ids=="")
	{
		...
		if(schedule=="")
		{
			...
			var url = "schedule_operation.php";
			  xmlhttp.open("POST",url,true);
			var params="aa=yes&op=insert&msg="+msg+"&mask="+mask+"&schedule="+schedule+"&ids="+ids;
   ...
   for(var i=1;i<=md.length-1;i++)
   {
	...
	if(ids=="")
	{
		...
		if(schedule=="")
		{
			...
			var url = "schedule_operation.php";
			  xmlhttp.open("POST",url,true);
			var params="id="+id +"&aa=yes&op=edit&msg="+msg+"&mask="+mask+"&schedule="+schedule+"&ids="+ids;
		xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xmlhttp.setRequestHeader("Content-length", params.length);
		xmlhttp.setRequestHeader("connection", "close");
			  xmlhttp.send(params);							 
 ...
 function tsearch() 
  {
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
		 var r=document.getElementById("sel_limit").value;
	  	    var url="schedule_operation.php?search="+ssearch +"&op=search&reclimit="+r ;
  ...
  function showall()
  {
   xmlhttp=GetXmlHttpObject();
	...
	document.getElementById("txtsearch").value="";
	  	    var url="schedule_operation.php?op=allsearch&reclimit="+r ;
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 else
	 {
	 	var field="sms_group";
	  	    ...
	  	    var url="pagingschedule.php?search="+ssearch +"&op=search&order=asc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random() ;    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
  ...
  function recperpage()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingschedule.php?reclimit="+reclimit+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
...
function offsetchange()
{
   ...
   var ssearch = document.getElementById("txtsearch").value;
   var url = "pagingschedule.php?reclimit="+reclimit+"&page="+page+"&pns="+pns+"&search="+ssearch;
   xmlhttp.open("GET",url,true);
   xmlhttp.send();	
}
   ...
   xmlhttp=GetXmlHttpObject();
    ...
    xmlhttp.onreadystatechange=function() 
	 ...
	 var ssearch = document.getElementById("txtsearch").value;
	  	    ...
	  	    var url="pagingschedule.php?search="+ssearch+"&op=search&order=desc&field="+field+"&page="+de+"&flag="+f1+"&page_no_start="+p+"&lastpage="+lp+"&lpr="+lpr+"&reclimit="+r+"&rn="+Math.random();    		
    		xmlhttp.open("GET",url,true);
    		xmlhttp.send(null);	
