<div id="table">
        ...
        <td colspan="5">
           ...
           <th class="thbackground" width="100%"> E-MAIL Template
                </th>
        ...
        <td class="tabletitle"><input type="checkbox" name="check" id="check"  onclick="checkall_none();"/></td>
			...
			{
				$sql ="select a.email_id,a.email_title,a.email_text from (select email_id,email_title,email_text from email_template where email_title like '%".$search."%' limit $offset,$rec_limit) a order by ".$_REQUEST['field']." ".$_REQUEST['order'];
			}
			else
			{
				$sql ="select email_id,email_title,email_text from email_template where email_title like '%".$search."%' limit $offset,$rec_limit";
            ...
            <td class="tdbg1"><?php echo stripslashes($row->email_title);?></td>
            <td class="tdbg1"><?php echo stripslashes($row->email_text); ?></td>
            ...
            <div align="center"><a onClick="javascript:update(<?php echo $row->email_id;?>,<?php echo $page-1; ?>,<?php echo $page_no_start; ?>,0,<?php echo $lastpage; ?>,<?php echo $last_page_rec; ?>,<?php echo $rec_limit; ?>)"><img src="images/edit-icon.png" title="Edit"/></a></div>
          <?php } ?>   		</td>  
               	</tr>
                </table>
                </td>
